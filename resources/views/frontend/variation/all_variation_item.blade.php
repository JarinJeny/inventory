...
@section('content')
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title" style="font-size: 28px; display: inline" >All Variations Item</h4>
                <a href="{{ route ('add-variation-item') }}">
                    <button type="button" class="btn btn-primary btn-icon-text" style="float: right; display: inline; margin: 0px 50px 20px 0px">
                        ...
                        </svg><p style="display: inline; font-size: 12px;">Add Variation Item</p> </button></a>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @foreach($variationitems as $variationitem)
                            <tr>
                                <td>{{$variationitem->id}}</td>
                                <td>{{$variationitem->name}}</td>
                                <td>{{$variationitem->variation->name}}</td>
                                <td>
                                    <div class="template-demo" style="display: inline">
                                        <a href="{{ route ('edit-variation-item', $variationitem->id) }}">
                                            <button type="button" class="btn btn-success btn-icon-text r-0" style="background-color: #23C584; color: white">
                                                <i class="mdi mdi-reload btn-icon-prepend"></i> Edit </button>
                                        </a>
                                    </div>
                                    <div class="template-demo" style="display: inline">
                                        <a href="{{ route ('variation-item-delete', $variationitem->id) }}" onclick="return confirm('Are you sure?')">
