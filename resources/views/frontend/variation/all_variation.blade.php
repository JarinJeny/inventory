...
@section('content')
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title" style="font-size: 28px; display: inline" >All Variations</h4>
                <a href="{{ route ('add-variation') }}">
                    <button type="button" class="btn btn-primary btn-icon-text" style="float: right; display: inline; margin: 0px 50px 20px 0px">
                        ...
                        </svg><p style="display: inline; font-size: 12px;">Add Variation</p> </button></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="template-demo" style="display: inline">
                                        <a href="{{ route ('edit-variation', $variation->id) }}">
                                    ...
                                    <div class="template-demo" style="display: inline">
                                        <a href="{{ route ('variation-delete', $variation->id) }}" onclick="return confirm('Are you sure?')">
