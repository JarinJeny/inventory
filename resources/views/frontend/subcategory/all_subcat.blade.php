...
@section('content')
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title" style="font-size: 28px; display: inline" >All Sub Category</h4>
                <a href="{{ route ('add-subcat') }}">
                <button type="button" class="btn btn-primary btn-icon-text" style="float: right; display: inline; margin: 0px 50px 20px 0px">
                    ...
                    </svg><p style="display: inline; font-size: 12px;">Add SubCategory</p> </button></a>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @foreach($subCategories as $subCategory)
                            ...
                            <td> {{$subCategory->slug}} <i class="mdi mdi-arrow-down"></i>
                            </td>
                            <td>
                                <label class="badge badge-danger" style="background-color: #DFDFE0; border-style: none; color: #1f262e">{{$subCategory->created_at}}</label>
                            </td>
                            <td>
                                <div class="template-demo" style="display: inline">
                                    <a href="{{ route ('edit-cat', $subCategory->slug) }}">
                                ...
                                <div class="template-demo" style="display: inline">
                                    <a href="{{ route ('cat-delete', $subCategory->id) }}" onclick="return confirm('Are you sure?')">
