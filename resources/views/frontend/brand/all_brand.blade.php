...
@section('content')
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title" style="font-size: 28px; display: inline" >All Brand</h4>
                ...
                <button type="button" class="btn btn-primary btn-icon-text" style="float: right; display: inline; margin: 0px 50px 20px 0px">
                    ...
                    </svg><p style="display: inline; font-size: 12px;">Add Brand</p> </button></a>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @foreach($brands as $brand)
                            ...
                            <td> {{$brand->slug}} <i class="mdi mdi-arrow-down"></i>
                            </td>
                            <td>
                                <label class="badge badge-danger" style="background-color: #DFDFE0; border-style: none; color: #1f262e">{{$brand->created_at}}</label>
                            </td>
                            <td>
                                <div class="template-demo" style="display: inline">
                                    <a href="{{ route ('edit-brand', $brand->slug) }}">
                                ...
                                <div class="template-demo" style="display: inline">
                                    <a href="{{ route ('brand-delete', $brand->id) }}" onclick="return confirm('Are you sure?')">
